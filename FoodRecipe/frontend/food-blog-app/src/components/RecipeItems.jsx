...
export default function RecipeItems() {
    ...
    const onDelete=async (id)=>{
      await axios.delete(`https://recipe-app-rgal.onrender.com/recipe/${id}`)
          ...
          allRecipes?.map((item,index)=>{
            return(
              <div key={index} className='card' onDoubleClick={()=>navigate(`/recipe/${item._id}`)}> 
                  <img src={`https://recipe-app-rgal.onrender.com/images/${item.coverImage}`} width="120px" height="100px"></img>
